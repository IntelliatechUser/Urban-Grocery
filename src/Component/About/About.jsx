...
export const About = () => {
  ...
  return (
    <>
       <div className=" flex mt-24 md:ml-10  xs:justify-center xs:items-center md:items-start sm:items-start md:flex-row md:justify-evenly sm:justify-evenly sm:flex sm:flex-row ">
        ...
        <div className=" border-r border-r-light_gray  mt-[-40px]  w-4 h-[110vh]"></div>
         ...
         <div className="md:w-[100%] sm:w-[60%] xs:w-[85%] overflow-y-auto h-[90vh] ml-4">
